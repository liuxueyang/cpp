...
int main(void) {
  ...
  Solution a;
  VI ve{3, 1};
  auto lst = CreateList(ve);
  auto res = a.nodesBetweenCriticalPoints(lst);
  dbg(res);

  ve = {5, 3, 1, 2, 5, 1, 2};
  lst = CreateList(ve);
  res = a.nodesBetweenCriticalPoints(lst);
  dbg(res);

  ve = {1, 3, 2, 2, 3, 2, 2, 2, 7};
  lst = CreateList(ve);
  res = a.nodesBetweenCriticalPoints(lst);
  dbg(res);
