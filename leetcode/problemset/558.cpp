 ...
 public:
  Node *intersect(Node *quadTree1, Node *quadTree2) {
    if (!quadTree1)
      ...
      auto res = new Node(
          true, false, intersect(quadTree1->topLeft, quadTree2->topLeft),
          intersect(quadTree1->topRight, quadTree2->topRight),
          intersect(quadTree1->bottomLeft, quadTree2->bottomLeft),
          intersect(quadTree1->bottomRight, quadTree2->bottomRight));

      vector<Node *> children{res->topLeft, res->topRight, res->bottomLeft,
                              res->bottomRight};
      ...
      if (all_leaf) {
        ...
        if (all_equal) return new Node(val, true);
      }
