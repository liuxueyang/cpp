...
class Solution {
 public:
  int longestSubsequence(vector<int> &a1, int delt) {
    int n{SZ(a1)}, ans{1}, g = 2e4;
    VI a(n + 10), d(4e4 + 10);
...
int main(void) {
  ...
  Solution a;
  VI ve{1, 2, 3, 4};
  auto res = a.longestSubsequence(ve, 1);
  dbg(res);
