...
uniform_int_distribution<ll> distrib;

ll rng1(ll l, ll r) {
  distrib = uniform_int_distribution<ll>(l, r);
  return distrib(rnd);
}
ll rng1(ll n) { return rng1(1, n); }
ll rng(ll n) { return rng1(n - 1); }

void solve() {
  cout << "1\n";
  int n = rng1(10);
  cout << n << '\n';
  For(i, 0, n) { cout << rng1(5) << ' '; }
  cout << '\n';
}
