...
// URL: https://vjudge.net/contest/784013#problem/B
// Memory Limit: 125 MB
// Time Limit: 1000 ms
//
...
struct Info {
  ...
  Info operator+(const Tag& t) const { return {sum + 1LL * t.val * len, len}; }
};
struct Node {
  Info info;
  Tag tag;
...
PII child(int x) { return {x * 2, x * 2 + 1}; }
