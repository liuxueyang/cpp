...
struct tag {
  ...
  tag operator+(const tag &rh) const {
    return tag(a * rh.a, (rh.a * b % MOD) + rh.b);
  }
};
...
void solve() {
  ...
  while (q--) {
    ...
    if (op == 1) {
      cin >> l >> r >> d;
      tree.modify(1, 1, n, l, r, tag(1, d));
    } else if (op == 2) {
      cin >> l >> r >> d;
      tree.modify(1, 1, n, l, r, tag(d, 0));
    } else if (op == 3) {
      cin >> l >> r >> d;
      tree.modify(1, 1, n, l, r, tag(0, d));
    } else {
      cin >> l >> r;
