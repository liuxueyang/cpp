...
void Init() {
  For1(i, '0', '9') { c2i[i] = i - '0'; }
  For1(i, 'A', 'Z') c2i[i] = i - 'A' + 10;
  For1(i, 'a', 'z') c2i[i] = i - 'a' + 36;

  For1(i, 0, 9) i2c[i] = '0' + i;
  For1(i, 10, 35) i2c[i] = 'A' + (i - 10);
  For1(i, 36, 61) i2c[i] = 'a' + (i - 36);
}
...
void solve() {
  ...
  while (nemp(a)) {
    ...
    res.pb(t);
    while (nemp(a) && a.back() == 0) a.pop_back();
  }
